<?php namespace App\Http\Controllers;
	...
	class AdminOficiosController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Dia","name"=>"dia","type"=>"text","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Lugar","name"=>"lugar","type"=>"text","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Hora","name"=>"hora","type"=>"text","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
